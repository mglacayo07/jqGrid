...
As jqGrid grows and the authentication method changes, only these tests
should be updated.
...
from jqgrid.tests import TestController
...
class TestAuthentication(TestController):
    ...
    def test_forced_login(self):
        ...
        jsonData when authorization is denied. Next, upon successful login they
        ...
        # Getting the login jsonData:
        resp = resp.follow(status=200)
        form = resp.form
        # Submitting the login jsonData:
        form['login'] = 'manager'
    ...
    def test_voluntary_login(self):
        ...
        # Going to the login jsonData voluntarily:
    ...
    def test_failed_login_keeps_username(self):
        """Wrong password keeps user_name in login jsonData"""
