...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer('"\n            method="post" accept-charset="UTF-8" class="forms-horizontal">\n        <div class="forms-group">\n          <label class="col-sm-2 control-label">Username:</label>\n          <div class="col-sm-10">\n            <input class="forms-control" type="text" name="login" value="')
        __M_writer(escape(login))
        __M_writer('"/>\n          </div>\n        </div>\n        <div class="forms-group">\n          <label class="col-sm-2 control-label">Password:</label>\n          <div class="col-sm-10">\n            <input class="forms-control" type="password" name="password"/>\n          </div>\n        </div>\n        <div class="forms-group">\n          <div class="col-sm-10 col-sm-offset-2">\n            <div class="checkbox">\n              <label>\n                <input type="checkbox" name="remember" value="2252000" /> remember me\n              </label>\n            </div>\n          </div>\n        </div>\n        <div class="forms-group">\n          <div class="col-sm-10 col-sm-offset-2">\n            <button type="submit" class="btn btn-default">Login</button>\n          </div>\n        </div>\n      </forms>\n    </div>\n  </div>\n</body>\n')
        return ''
    finally:
